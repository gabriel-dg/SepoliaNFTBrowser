    ...
    return (
        ...
        <div className="w-1/4 flex flex-col">
            ...
            <div className="flex justify-center mb-1">
                ...
                <a target={"_blank"} href={`https://etherscan.io/token/${nft.contract.address}`} className="py-2 px-4 bg-green-700 w-3/5 text-center rounded-lg text-white cursor-pointer hover:bg-green-600">View on Etherscan</a>
            </div>
        </div >
    )
}
